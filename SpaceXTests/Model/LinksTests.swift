...
class LinksTests: XCTestCase {
    func testDecodeJson() throws {
        ...
        XCTAssertEqual(links.map { $0.hasInfo }, [true, true, false])
...
private extension LinksTests {
    ...
    var expectedArticles: [String?] {
        ["https://www.space.com/2196-spacex-inaugural-falcon-1-rocket-lost-launch.html", nil, nil]
    }
    
    var expectedWikipedias: [String?] {
        ["https://en.wikipedia.org/wiki/DemoSat", nil, nil]
    }
}
